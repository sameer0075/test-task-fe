...
import { useRows, stableSort, getComparator } from '../Components/Generic-Components/Table/helper-functions';
...
export function useTableState() {
    ...
    const [rowsPerPage, setRowsPerPage] = useState(2); // RowsPerPage state
    const rows = useRows(); // Rows state
