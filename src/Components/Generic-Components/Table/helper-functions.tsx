...
/**
 * Creates a Data object based on the provided parameters.
 * 
 * @param id - The ID of the data.
 * @param name - The name of the data.
 * @param email - The email of the data.
 * @param phone - The phone number of the data.
 * @param role - The role of the data.
 * @returns A Data object containing the provided information.
 */
function createData(
  id: string,
  name: string,
...
/**
 * A custom hook that returns an array of Data objects containing
 * dummy data for table rows.
 *
 * @returns An array of Data objects.
 */
function useRows() {
  // Use the useMemo hook to memoize the array of Data objects.
  // The array is created only once and is reused on subsequent renders.
  // The dependency array is empty, indicating that the array should only be created once.
  const rows = useMemo(
    () => [
      // Create Data objects with dummy data for table rows.
      createData('1', 'Test', '305@example.com', '123-456-7890', 'Developer'),
      createData('2', 'Test2', '452@example.com', '123-456-7890', 'Admin'),
      createData('3', 'Test3', '262@example.com', '123-456-7890', 'Manager'),
    ],
    []
  );
...
export { useRows, getComparator, stableSort, EnhancedTableHead };
